...
<center>
	...
	<br><br>
		...
		<table id="main"><!-- cellspacing="0" -->
			...
			<tr><td bgcolor="#FBFAFA" width=135 height=43>&nbsp;아이디<b>*</b></td>
				<td id="test">
					<input type="text" title="아이디" id="join_id" autofocus="autofocus"
						   name="join_id" value="" maxlength="15" onkeyup="id_check()"/>
			...
			<tr><td bgcolor="#FBFAFA" height=43>&nbsp;비밀번호 확인 답변<b>*</b></td>
				<td>
					<input type="text" title="비밀번호 확인 답변" id="join_passa"
						   name="join_passa" maxlength="80" value="" size="80">
				</td>
			</tr>
			<tr><td bgcolor="#FBFAFA" height=43>&nbsp;이름<b>*</b></td>
				<td>
					<input type="text" title="이름" id="join_name"
						   name="join_name" maxlength="30" value="" size="10">
				</td>
			</tr>
			<tr><td id="gender" bgcolor="#FBFAFA" height=43>&nbsp;성별<b>*</b></td>
				<td>
					<input type=radio name=join_gender id=male value="남자">남자
					<input type=radio name=join_gender id=female value="여자">여자
				</td>
			</tr>
			
			<tr><td bgcolor="#FBFAFA" height=97>&nbsp;주소<b>*</b></th>
						<td><input type="text" style="width: 100px;" onclick="post_search()"
							       name="join_post" id="join_post" readOnly="readOnly" size="6">
				...
				<td>	
					<select id="join_phone1" name="join_phone1" style="width: 60px; height: 22px;">
						...
						<option value="019">019</option>
							...
							maxlength="4" size="4" /> - <input type="text" name="join_phone3" id=join_phone3 validate="number"
							allowtype="number" maxlength="4" / size="4"></td>
			</tr>
			<tr>
				<td height=43 bgcolor="#FBFAFA">&nbsp;이메일<b>*</td>
					<td><input type=text id="join_email1" name="join_email1" height=43/> ＠ 
					    <input type=text id="join_email2" name="join_email2" height=43 readonly="readonly"/> 
						<select name="domain" id="domain" style="width: 110px; height: 22px;" onchange="domain_list()">
			...
			<tr><td bgcolor="#FBFAFA" height=43>&nbsp;플리즈를 어떻게 알고<br>&nbsp;오셨나요?<b>*</b></td>
				<td>
					<input type="text" title="플리즈를 어떻게 알고 오셨나요?" id="join_know"
						   name="join_know" maxlength="80" value="" size="80">
				</td>
			</tr>
		</table>
				
		<table><br>
			<tr><td td width=1020><b>이용약관 동의</b></div></td></tr><br>
			<tr><td><hr align="left" style="border: 0px solid #E4E4E4; width: 1020px;"></td></tr>
		</table>	
	<table id="sub">
		<tr><td bgcolor="#FBFAFA" height=145>
		<font STYLE="font-family: 굴림체" color="#747474"	size="2px">
			<div style="aligh:center; background-color:white;
				 border: 1px solid #E4E4E4; 
				 overflow-y:scroll; width:940px; height:125px;  margin:20px 20px 5px 20px; padding:20px; border:1 solid #000000;">
	제1조(목적)<br>
     이 약관은 플리즈 회사(전자상거래 사업자)가 운영하는 플리즈사이버 몰(이하 “몰”이라 한다)에서 제공하는 인터넷 관련 서비스(이하 “서비스”라 한다)를 이용함에 있어 사이버 몰과 이용자의 권리․의무 및 책임사항을 규정함을 목적으로 합니다.
	※「PC통신, 무선 등을 이용하는 전자상거래에 대해서도 그 성질에 반하지 않는 한 이 약관을 준용합니다.」<br><br>
	제2조(정의)<br>
	① “몰”이란 플리즈 회사가 재화 또는 용역(이하 “재화 등”이라 함)을 이용자에게 제공하기 위하여 컴퓨터 등 정보통신설비를 이용하여 재화 등을 거래할 수 있도록 설정한 가상의 영업장을 말하며, 아울러 사이버몰을 운영하는 사업자의 의미로도 사용합니다.
	...
	부 칙(시행일) 이 약관은 년 월 일부터 시행합니다.
		...
		<tr><td bgcolor="#FBFAFA">
				<font STYLE="font-family: 굴림체" color="#747474"	size="2px">&nbsp;&nbsp;&nbsp;<b>이용약관에 동의하십니까?</b>
				<input type="checkbox" name="join_agree" id="join_agree" value="동의함">동의함
			</td>
		</tr>
		<tr><td><hr align="left" style="border: 0px solid #E4E4E4; width: 1020px;"></td>
		</tr>
	</table>
	
	<table><br>
		<tr><td td width=1020><b>개인정보 수집 및 이용 동의</b></div></td></tr><br>
		<tr><td><hr align="left" style="border: 0px solid #E4E4E4; width: 1020px;"></td></tr>
	</table>	
		<table id="sub">
		<tr><td bgcolor="#FBFAFA" height=145>
		<font STYLE="font-family: 굴림체" color="#747474"	size="2px">
			<div style="aligh:center; background-color:white;
				 border: 1px solid #E4E4E4; 
				 overflow-y:scroll; width:940px; height:125px;  margin:20px 20px 5px 20px; padding:20px; border:1 solid #000000;">
    &nbsp;** 본 양식은 쇼핑몰 운영에 도움을 드리고자 샘플로 제공되는 서식으로 쇼핑몰 운영형태에 따른 수정이 필요합니다. 쇼핑몰에 적용하시기 전, 쇼핑몰 운영 사항 등을 확인하시고 적절한<br><br>
	내용을 반영하여 사용하시기 바랍니다. **<br><br>
	...
	나. 회원 관리<br><br>
	회원제 서비스 이용에 따른 본인확인 , 개인 식별 , 불량회원의 부정 이용 방지와 비인가 사용 방지 , 가입 의사 확인 , 연령확인 , 만14세 미만 아동 개인정보 수집 시 법정 대리인 동의여<br><br>
	부 확인, 불만처리 등 민원처리 , 고지사항 전달<br><br>
	...
	<tr><td bgcolor="#FBFAFA">
			<font STYLE="font-family: 굴림체" color="#747474"	size="2px">&nbsp;&nbsp;&nbsp;<b>개인정보 수집 및 이용에 동의하십니까?</b>
			<input type="checkbox" name="join_infoagree" id="join_infoagree" value="동의함">동의함
		</td>
	</tr>
	<tr><td><hr align="left" style="border: 0px solid #E4E4E4; width: 1020px;"></td></tr>
	
</table><br>
	<input type="submit" name="" id="join_btn" value="회원가입">
	<input type="button" name="" id="join_btn2" value="회원가입 취소"
		   onclick="location.href='/please/main.member';">
</form><br><br>
