...
/* 	}
			...
			$('input[name="ca_name2"]:checked').val() == "영업완료" )
...
<br><br>
	...
	<table id="main" broder-spacing: 0px 0px;><!-- cellspacing="0" -->
			...
			<tr><td width=130>
				...
				<td>
					<input type="text" id="join_id" autofocus="autofocus"
					       name="join_id" maxlength="15"/>
				</td>
			</tr>
			<tr><td id="find" colspan="2">
					<input type=radio name="findselect" id="question" value="question" onclick="find()">확인질문
			...
			<tr>
				...
				<td><div id="emailfind2">
					<input type="text" id="join_id" name="join_id" maxlength="15"/>
					</div>
				</td>
			</tr>
