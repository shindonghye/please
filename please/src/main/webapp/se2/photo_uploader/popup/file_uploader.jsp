...
<%
String path = "C:/Users/Administrator/git/please/please/src/main/webapp/se2/upload" ; // 이미지가 저장될 주소
//String path = "/daparo/editor/upload" ; 
...
<%
	...
	try {
		...
		MultipartRequest multi=new MultipartRequest(request, path, 15*500*1024, "UTF-8", new DefaultFileRenamePolicy());
