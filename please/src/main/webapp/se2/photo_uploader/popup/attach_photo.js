...
// 			sUrl  : location.href.replace(/\/[^\/]*$/, '') + '/file_uploader.php',	//샘플 URL입니다.
 			sUrl  : location.href.replace(/\/[^\/]*$/, '') + '/please/se2/photo_uploader/popup/file_uploader.jsp',	//샘플 URL입니다.
 	        sCallback : location.href.replace(/\/[^\/]*$/, '') +  '/please/se2/photo_uploader/popup/callback.html',	//업로드 이후에 iframe이 redirect될 콜백페이지의 주소
