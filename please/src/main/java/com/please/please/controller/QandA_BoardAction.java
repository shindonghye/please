...
import com.please.please.service.QandA_BoardServiceImpl;
...
@Controller
public class QandA_BoardAction {
	...
	@Autowired
	private QandA_BoardServiceImpl boardService;
	...
	public String board_write_ok(@ModelAttribute QandA_BoardBean qna)
			throws Exception {
...
//		return "redirect:/QandA_list.qna";
	...
	public ModelAndView board_cont(@RequestParam("item_num") int board_num,
		...
		QandA_BoardBean board = boardService.board_cont(board_num);
	...
	public String board_del_ok(@RequestParam("item_num") int item_num,
		...
		int result = boardService.del_ok(response, item_num, item_pass);
